    ...
    <div className="container">
      ...
      <div className="card">
        ...
        <div className="mut" style={{ fontSize: 12 }}>
          Every system on the platform, who owns it, and who can see it. Ownership decides who fields access requests;
          visibility comes only from the organizations listed. Both are yours to change here - an ownership claim granted
          in error is undone by reassigning the owner and withdrawing the share.
        </div>
      </div>
